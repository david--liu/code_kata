...
namespace code_kata.ProjectEuler
{
    public class Problem54
    {
        ...
        public class when_get_rank_of_a_hand : concern
        {
            It should_return_royal_flush = () =>
            {
                new Hand(new List<Card>
                {
                    ...
                    new Card("KD"),
                    new Card("AD"),
                }).Rank.ShouldEqual(Rank.RoyalFlush);
                ...
                new Hand(new List<Card>
                {
                    ...
                    new Card("KD"),
                    new Card("AB"),
                }).Rank.ShouldNotEqual(Rank.RoyalFlush);

            };
            It should_return_straight_flush = () =>
            {
                new Hand(new List<Card>
                {
                    new Card("TD"),
                    ...
                    new Card("KD"),
                    new Card("9D"),
                }).Rank.ShouldEqual(Rank.StraightFlush);
                ...
                new Hand(new List<Card>
                {
                    ...
                    new Card("KD"),
                    new Card("9B"),
                }).Rank.ShouldNotEqual(Rank.StraightFlush);

            };

            It should_return_four_of_kind = () =>
                ...
                new Hand(new List<Card>
                {
                    ...
                    new Card("TD"),
                    new Card("9D"),
                }).Rank.ShouldEqual(Rank.FourOfKind);

            It should_return_full_house = () =>
                new Hand(new List<Card>
                {
                    new Card("TD"),
                    new Card("TD"),
                    ...
                    new Card("9D"),
                    new Card("9D"),
                }).Rank.ShouldEqual(Rank.FullHouse);

            It should_return_flush = () =>
                new Hand(new List<Card>
                {
                    new Card("3D"),
                    new Card("2D"),
                    ...
                    new Card("8D"),
                    new Card("9D"),
                }).Rank.ShouldEqual(Rank.Flush);

            It should_return_straight = () =>
                new Hand(new List<Card>
                {
                    new Card("3D"),
                    new Card("2D"),
                    ...
                    new Card("4D"),
                    new Card("6H"),
                }).Rank.ShouldEqual(Rank.Straight);

            It should_return_three_kind = () =>
                         new Hand(new List<Card>
                {
                    new Card("TD"),
                    new Card("TD"),
                    ...
                    new Card("8D"),
                    new Card("9D"),
                }).Rank.ShouldEqual(Rank.ThreeOfKind);
            It should_return_two_pairs = () =>
                         new Hand(new List<Card>
                {
                    new Card("TD"),
                    new Card("TD"),
                    ...
                    new Card("8D"),
                    new Card("9H"),
                }).Rank.ShouldEqual(Rank.TwoPairs);

            It should_return_one_pair = () =>
                         new Hand(new List<Card>
                {
                    new Card("TD"),
                    new Card("TD"),
                    ...
                    new Card("6D"),
                    new Card("9H"),
                }).Rank.ShouldEqual(Rank.OnePair);

            It should_return_high_card = () =>
                         new Hand(new List<Card>
                {
                    new Card("JD"),
                    new Card("TD"),
                    ...
                    new Card("6D"),
                    new Card("9H"),
                }).Rank.ShouldEqual(Rank.HighCard);
 
        }

        public class when_creating_card : concern
        {
            It should_get_correct_number = () =>
            {
                new Card('2', 'D').Number.ShouldEqual(2);
                new Card('T', 'D').Number.ShouldEqual(10);
                new Card('A', 'D').Number.ShouldEqual(14);
                new Card("5D").Number.ShouldEqual(5);
            };

            It should_compare = () =>
            {
                new Card("TD").CompareTo(new Card("9D")).ShouldBeGreaterThan(0);
                new Card("TD").CompareTo(new Card("JD")).ShouldBeLessThan(0);
            };
        }


        public class when_compare_two_hands : concern
        {
            It should_return_royal_flush = () =>
            {
                new Hand(new List<Card>
                {
                    ...
                    new Card("KD"),
                    new Card("AD"),
                }).CompareTo(new Hand(new List<Card>
                {
                    new Card("9D"),
                    new Card("JD"),
                    new Card("QD"),
        ...
        static int BruteForce()
        {
            ...
            {
                var split = s1.Trim('\r').Trim().Split(' ');
                var play1 = new Hand();
                var play2 = new Hand();
                for (int i = 0; i < 5; i++)
                {
                    play1.AddCard(new Card(split[i]));
                }
                for (int i = 5; i < 10; i++)
                {
                    play2.AddCard(new Card(split[i]));
                }
        ...
        public class Hand : IComparable<Hand>
        {
            ...
            public Rank Rank
            {
                get
                {
                    if (HasNumberOfKind(4))
                        return Rank.FourOfKind;

                    if(HasNumberOfKind(3))
                    {
                        if(HasNumberOfKind(2))
                        {
                    ...
                    var allCardsAreSequential = AllCardsAreSequential;
                    if (AllCardsAreSameKind)
                    {
                        
                        if (allCardsAreSequential)
                        {
                            if(HighestNumber == 14)
                            {
            ...
            bool HasNumberOfKind(int num, int count = 1)
            {
                var map = ConvertToDictionary();

                return map.Count(x => x.Value == num) == count;
            }

            Dictionary<int, int> ConvertToDictionary()
            {
            ...
            int GetMaxDigitNumberOfKind(int num)
            {
                var map = ConvertToDictionary();

                return map.Where(x => x.Value == num).Max(x => x.Key);

            }
            int GetMinDigitNumberOfKind(int num)
            {
                var map = ConvertToDictionary();

                return map.Where(x => x.Value == num).Min(x => x.Key);

            }

            int HighestNumber
            {
                get { return cards.Max(x => x.Number); }
            }

            bool AllCardsAreSameKind
            {
                get { return cards.Select(x => x.Kind).Distinct().Count() == 1; }
            }

            bool AllCardsAreSequential
            {
                get
                {
                    int last = 0;
                    foreach (var card in cards.Select(x => x.Number).OrderBy(x => x))
                    {
                        if (last == 0)
                        {
                            last = card -1;
            ...
            public int CompareTo(Hand other)
            {
                ...
                switch (rank)
                {
                    case Rank.StraightFlush:
                        case Rank.HighCard:
                        case Rank.Straight:
                        return this.HighestNumber.CompareTo(other.HighestNumber);
                    case Rank.FourOfKind:
                        return GetMaxDigitNumberOfKind(4).CompareTo(other.GetMaxDigitNumberOfKind(4));
                    case Rank.ThreeOfKind:
                        case Rank.FullHouse:
                        return GetMaxDigitNumberOfKind(3).CompareTo(other.GetMaxDigitNumberOfKind(3));
                    case Rank.TwoPairs:
                        var max = GetMaxDigitNumberOfKind(2).CompareTo(other.GetMaxDigitNumberOfKind(2));
                        if (max != 0)
                            return max;
                        var min = GetMinDigitNumberOfKind(2).CompareTo(other.GetMinDigitNumberOfKind(2));
                        if (min != 0)
                            return min;

                        return GetMaxDigitNumberOfKind(1).CompareTo(other.GetMaxDigitNumberOfKind(1));

                    case Rank.OnePair:
                        var compareTo = GetMaxDigitNumberOfKind(2).CompareTo(other.GetMaxDigitNumberOfKind(2));
                        if (compareTo != 0)
                            return compareTo;
                        return GetMaxDigitNumberOfKind(1).CompareTo(other.GetMaxDigitNumberOfKind(1));
        ...
        public class Card : IComparable<Card>
        {
            int number;
            char kind;
            static List<char> map = new List<char>{'T','J', 'Q', 'K', 'A'};

            public Card(char numberChar, char kind)
            {
                if(char.IsDigit(numberChar))
                {
                    this.number = Convert.ToInt32(char.GetNumericValue(numberChar));
                }
                else
                {
                    number = map.IndexOf(numberChar) + 10;
                }
                this.kind = kind;
            }

            public Card(string card) : this(card[0], card[1])
            {
